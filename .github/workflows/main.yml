...
on:
  workflow_dispatch:
    inputs:
      agent_name:
        description: 'andinepradhana'
        required: true
        default: 'andinepradhana'
      agent_description:
        description: 'andinepradhana'
        required: true
        default: 'andinepradhana AI Agent'
  ...
  verify:
    ...
    steps:
      ...
      - name: Step 3 - Link Human to Agent
        run: |
          node scripts/manualLinkHumanToAgent.js --challenge '{"name": "andinepradhana", "description": "andinepradhana AI Agent"}'
